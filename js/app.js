...
// const switch = ()=>{
// // store a light switch as an object and then create a function to turn it on and off
// }

// 2. A user's email address.

// a string 
// const email = 'gfrye414@yahoo.com'

// 3.A spaceship with a hull, laser blasters, tractor beam, and warp drive.

// an array
// const outerSpace = ['spaceship', 'hull', 'laser blasters', 'tractor beam', 'warp drive']

// 4.A list of student names from our class.

// const newArray = ['Chris','Chris','Fillip']
// store a list of names in an array

// 5.A list of student names from our class, each with a location.

  // const system = { store names with location as an object
  // student1: { 
  //       name: 'Jon',
  //      	location: 'desk'
  //      },
...
// const students = {
// 	{ name: 'Greg', location: 'Home', movies: ['Roadhouse'] }
// store the list of movies in an array and that array along with name and location as an object
